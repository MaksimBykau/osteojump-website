...
function processPage(slug, lang, translations) {
  ...
  // 18. Inject Google tag (Google Ads AW-16731693756)
  $('head').append(`
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-16731693756"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'AW-16731693756');
    </script>`);

  // 19. Inject PostHog analytics (cookieless, GDPR-compliant)
  $('head').append(`
    <script>
