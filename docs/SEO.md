...
- [x] 80 статических HTML (16 страниц × 5 языков)
...
- [ ] **ZnanyLekarz** — зарегистрироваться после получения европейского диплома (с июня 2026)
- [x] **Booksy** — ссылка на сайт добавлена, описание обновлено с SEO-ключевиками (2026-03-01)
- [x] **Google Business Profile** — настроен ранее
